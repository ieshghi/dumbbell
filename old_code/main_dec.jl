...
using DelimitedFiles
    ...
    function xdot(x1,x2,g,k,u,grav,pottype,l)
        force = [-sprgpot(x1,x2,k,l) - extgpot(x1,u,pottype) ,sprgpot(x1,x2,k,l) ]-grav.*ones(2);
        return force./g;
    end
...
#        dts = 1.;
    ...
    function runsim()
        ...
        writedlm("./data/decoupled_hot/sl_stiffspr",sl_stiffspr);
        writedlm("./data/decoupled_hot/sl_softspr",sl_softspr);
